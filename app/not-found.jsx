          ...
          <div className="-mx-4 flex">
            <div className="w-full px-4">
              <div className="relative z-10 mx-auto max-w-[570px] rounded-[20px] bg-primary px-10 py-16 text-center sm:px-16 md:py-24">
                ...
                <Link href="/" className="inline-block rounded-lg border border-white bg-white px-8 py-3 text-center text-base font-semibold text-primary transition hover:bg-opacity-90">
                    Go To Home
                </Link>
                <div>
