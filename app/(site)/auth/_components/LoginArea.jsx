        ...
        <div>
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-5 items-center justify-between sm:flex">
              ...
              <div>
                <button onClick={(e) => router.push("/auth/forgot-password")} type="button">
                  <a className="text-primary text-sm transition hover:underline">
                    Forgot Password?
                  </a>
                </button>
              </div>
          ...
          <p className="text-body-color flex items-center justify-center text-center text-sm font-medium">
            ...
            <button onClick={(e) => router.push("/auth/register")}>
              <a className="hover:text-primary pl-1 font-medium text-black underline underline-offset-2 transition-all">
                Create an Account
              </a>
            </button>
          </p>
