          ...
          >
            <div>
              <div className="text-center">
                ...
                <p className="mb-8 text-base font-normal text-body-color">
                ...
                <button
                  ...
                  className="flex h-[52px] w-full items-center justify-center rounded-[30px] bg-primary font-heading text-base font-medium text-white duration-300 hover:bg-fb-primary-hover"
                >
