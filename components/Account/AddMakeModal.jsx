...
const AddMakeModal = (props) => {
  ...
  //   https://hook.eu2.make.com/a2fq2it0yfkee8fqax4jirpdeyabucil
  const isValidMakeWebhook = (url) => {
    const makeWebhookRegex =
      /^https:\/\/hook\.eu2\.make\.com\/[a-zA-Z0-9]{20,40}$/;
    return makeWebhookRegex.test(url);
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (!isValidMakeWebhook(webhookUrl)) {
      setErr({
    ...
    currentForm && dispatch(addMakePlugin(payload));
  };
