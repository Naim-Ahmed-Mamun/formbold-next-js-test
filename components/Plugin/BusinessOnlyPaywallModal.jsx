...
const BusinessOnlyPaywallModal = (props) => {
            ...
            <div>
              <div className="text-center">
                ...
                <h3 className="mx-auto mb-4 max-w-[420px] font-heading text-[28px] font-bold leading-tight text-black">
                  Upgrade to Business Plan to Access This Features!
                </h3>
                <p className="mb-8 text-base text-body-color">
                  You just discovered a Business Plan Only feature - please
                  upgrade your plan to a Business Plan to unlock this feature.
                </p>
                <button
...
export default BusinessOnlyPaywallModal;
