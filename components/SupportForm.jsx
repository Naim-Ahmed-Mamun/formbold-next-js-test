...
export default function SupportForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://formbold.com/s/9gVl6`, {
        method: "POST",
      ...
      <div className="container">
        <div className="flex">
          <div className="w-full">
            <SectionTitleH1
              title="Need any kind of help? Open a Ticket"
              paragraph="If you have any question in your mind feel free to create  a support ticket,
