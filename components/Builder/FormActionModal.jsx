...
import { changeEmbeddedContentVisibility } from "../../actions/FormAction";
import CopyButton from "../Account/CopyButton";
import useClickOutside from "../../hooks/useClickOutside";

const FormActionModal = (props) => {
  ...
  useEffect(() => {
    if (formAction === "code" && !isNil(embeddedCode) && show) {
      Prism.highlightAll();
    }
  }, [embeddedCode, formAction, show]);
