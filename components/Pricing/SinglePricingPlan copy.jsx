...
const SinglePricingPlan = ({ plan, handelOpenCheckout, loading, yearly }) => {
  ...
  const offers = [
    ...
    { text: "Access to Apps", Icon: plan.price > 0 ? Checkmark : CrossIcon },
    {
  ...
  return (
    <div
      className={`relative col-span-1 flex flex-col justify-between px-6 py-11 sm:px-9 md:px-6 xl:px-6 2xl:px-9 ${
        ...
        "mt-14 rounded-b-xl border-4 border-[#D7EDFF] bg-white md:mt-0"
      }`}
    >
      {(plan.name === "Premium" || plan.name === "Premium - Monthly") && (
      ...
      <div>
        <div className="mb-3 flex items-center">
          {/* <div
            className="h-9 w-full max-w-[36px] pr-2 pt-1"
          ...
          <h3
            className={`truncate font-heading text-3xl font-bold ${
        ...
        <p className="font-heading text-base font-medium text-body-color">
        ...
        <div className="mb-10 flex items-end border-b border-fb-gray-3 pb-7.5">
          <span className="pr-3.5 font-heading text-2xl font-black !leading-tight text-fb-gray-6 line-through md:text-[28px] lg:text-3xl 2xl:text-4xl">
            {"$"}
            {plan.previous_price}
          </span>
      ...
      <div>
        <div className="mb-3 mt-8">
          <ButtonWithText
            ...
            className={`flex h-[52px] w-full items-center justify-center rounded-3xl border font-heading text-base font-medium duration-300  ${
              plan.name === "Premium" || plan.name === "Premium - Monthly"
