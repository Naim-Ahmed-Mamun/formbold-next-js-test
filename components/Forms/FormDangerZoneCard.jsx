...
import { deleteForm, resetReuestSuccess } from "../../actions/FormAction";
import Loader from "../Icons/Loader";

const FormDangerZoneCard = () => {
  ...
  useEffect(() => {
    if (formPage?.requestSucess) {
      dispatch(resetReuestSuccess());
      router.push("/account/forms");
    }
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [formPage?.requestSucess]);

  const handelDeleteForm = (e) => {
    e.preventDefault();
  ...
  return (
    <div className="rounded-[10px] bg-white p-6 shadow-fb-one sm:p-10 xl:p-8 2xl:p-10">
      ...
      <h4 className="mb-2.5 text-base font-medium text-black">Delete Form</h4>

      <p className="mb-6 text-sm text-body-color">Deleting the form will erase all traces of this form, including all submissions and file uploads.</p>
...
export default FormDangerZoneCard;
