...
<div class="flex items-center justify-center p-12">
  <div class="w-full">
    <div
      class="form-wrapper border-stroke mx-auto w-full max-w-[550px] rounded-lg border bg-white"
    >
      <div
        class="flex items-center justify-between rounded-t-lg bg-primary py-4 px-9"
      >
      ...
      <form class="py-6 px-9">
        ...
        <div class="mb-5">
          ...
          <textarea
            ...
            class=" border-stroke focus:shadow-form w-full resize-none rounded-md border bg-white py-3 px-6 text-base font-medium text-body-color outline-none focus:border-primary"
          ></textarea>
        </div>
        <div>
          <button
